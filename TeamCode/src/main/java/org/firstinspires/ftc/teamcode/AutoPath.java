...
public class AutoPath extends LinearOpMode {
    ...
    private final Pose point2 = poseFactory.of(24, 36, 180);
    private final Pose point3 = poseFactory.of(24, 108, 90);
    private final Pose point4 = poseFactory.of(12, 108, 180);
